...
#plot <x12>00
plt.plot(x,(1/np.sqrt(2))*(zeta_p(x) - zeta_m(x)), "tomato", label="$<x_1>_{00}(t)$", linewidth=4)
plt.plot(x,(1/np.sqrt(2))*(zeta_p(x) + zeta_m(x)), "maroon", label="$<x_2>_{00}(t)$",linewidth=4)
plt.xlabel("$t/s$", fontsize=20)
plt.ylabel("$Auslenkung/m$", fontsize=20)
