...
\section{Floquet Theorie und Floquet'sches Theorem}
  ...
  \section{Allgemeine L"osung der Schr"odinger-Gleichung des getriebenen harmonischen Oszillators in der Quantenmechanik}
    ...
    \subsection{\texorpdfstring{Identifizierung der Quaienergien $\epsilon_n$ und Floquet-Moden $\Phi_n(x,t)$}{Identifizierung der Quaienergien \epsilon_n und Floquet-Moden \Phi_n(x,t)}}
      ...
      Das Ergebnis des Integrals "uber die Lagrange Funktion kann nur $T$-periodisch oder linear in $t$ sein, so wie $E_n$, daher sind die Quasienergien gegeben durch
      \begin{equation}
        \epsilon_n = E_n - \frac{1}{T} \int_0^T L(\dot \zeta, \zeta, t) \: \text d t
      \end{equation}
      und die Floquet-Moden durch
      \begin{equation}
