...
\section{Wellenfunktion}
  ...
  Für die $\ket{\Psi_n(t)}$ des getriebenen harmonischen Oszillators wählen wir konkret den Ansatz
  \begin{equation}
  ...
  Für die Anwendung des Hamilton-Operators $H(x,p,t)$ auf den Zustand $\ket{\Psi(t)}$ folgt
  \begin{align}
...
\section{Erwartungswerte}
  ...
  \textbf{Erwartungswerte des Ortes}
  ...
  Schließlich erhalten wir für den Ort und den Impuls des einzelnen getriebenen Oszillators und folglich auch für die Energie in der Besetzungszahldarstellung die Erwartungswerte, wie wir sie schon in Kapitel \ref{3} in Ortsdarstellung erhalten haben.
\iffalse
