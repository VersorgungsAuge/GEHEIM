...
\fi
  ...
  \subsection{Erwartungswerte der Energie}
    ...
    Für das Beispiel der Sinus-Kraft folgt $\braket{H(t)}_{n,l}$ mit den ensprechenden Orts- und Impulserwartungswerten aus vorherigem Abschnitt und  $\bar H_{n,l}$ folgt aus Gleichung (\ref{mittleres_H}).
